...
patch_model_path="./data_cache/flower_c_patch.pt"
visualize_patchnet=False
if_train_r=True
continue_train_r=False
raw_model_path="./data_cache/flower_c_raw.pt"
######################
...
def prepare_train_r(model,func_params, data):
    ...
    train_dic={"bd":(compute_loss_bd, (None, 0, 0), (func_params, X_bd, U_bd)),
               ...
               "inj":(compute_loss_inj,(None,0,0),(func_params, X_interf, U_inj)),
               }
    return train_dic
...
if if_train_r:
    data_r = databuilderforBase(g_base,patchnet,reference_u,n_boundary=120,n_interface=120,n_inner=1600,random_method="Hammersley",device=device)
