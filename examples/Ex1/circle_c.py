...
patch_model_path="./data_cache/circle_c_patch.pt"
visualize_patchnet=False
if_train_r=True
continue_train_r=False
raw_model_path="./data_cache/circle_c_raw.pt"
######################
...
if if_train_p:
    ...
    func_params_p = gdlm_train(train_dic,LM_iter=800,imethod=2,iaccel=1,ibold=2,continue_train=continue_train_p,model_path=patch_model_path,otherkw={"Cgoal":-1,"ftol":-1,"gtol":-1}) 
