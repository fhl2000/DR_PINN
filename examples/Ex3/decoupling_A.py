...
def main(args):
    ...
    patch_model_path=f"data_cache/comparison_{information}_{network_type}_{optimizer_type}_a_patch_{args.seed}.pt"

    continue_train_r=args.continue_train
    raw_model_path=f"data_cache/comparison_{information}_{network_type}_{optimizer_type}_a_raw_{args.seed}.pt"
    ######################
