...
def main(args):
    ...
    patch_model_path=f"data_cache/comparison_{information}_{network_type}_{optimizer_type}_b_patch_{args.seed}.pt"

    continue_train_r=args.continue_train
    raw_model_path=f"data_cache/comparison_{information}_{network_type}_{optimizer_type}_b_raw_{args.seed}.pt"
